...
{
    public class ProductsFilteredService : IProductsFilteredService
    {
        ...
        public ProductsFilteredService(IRepository<Product, int> productRep, IRepository<ProductType, int> productTypeRep, IMapper mapper, IHostingEnvironment hostingEnvironment)
        {
