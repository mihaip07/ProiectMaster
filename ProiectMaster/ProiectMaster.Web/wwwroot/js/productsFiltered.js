window.ProductsFiltered = (function ($) {

    let editUrl = "/ProductsFiltered/Edit/{0}";
    let deleteUrl = "/ProductsFiltered/Delete/{0}"
    ...
    return {
        ...
        onSearchBtnPress: _onSearchBtnPress,
